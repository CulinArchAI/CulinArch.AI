...
This repository contains the production-connected public website for **CulinArchAI**, a research-led culinary intelligence platform.
...
- Pull requests receive a Vercel preview before merge.
- Preview and development deployments are `noindex` through metadata and robots routes.
