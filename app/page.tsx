      ...
      <main id="main-content">
          ...
          <div className="site-shell hero-grid">
            <div className="hero-copy">
              ...
              <p className="hero-summary">
                CulinArchAI is a research-led platform for structuring culinary knowledge,
                ingredients, techniques, culture, sensory relationships, and professional
                decision-making.
              </p>
        ...
        >
          <div className="site-shell split-layout">
            ...
            <div className="prose-stack">
              <p>
                Recipes preserve outcomes, but they rarely capture the full structure behind
                them: technique, transformation, provenance, sensory intent, operational
                context, and cultural lineage.
              </p>
              <p>
                CulinArchAI is being built to connect those layers without reducing cuisine to
                a list of ingredients or treating AI as an authority above culinary craft.
              </p>
            </div>
          </div>
          ...
          <div className="site-shell signal-grid" aria-label="Knowledge gaps">
            <article>
              ...
              <p>
                Large collections become useful only when entities, sources, and
                transformations can be connected.
              </p>
            </article>
            <article>
              ...
              <p>
                Professional culinary logic depends on why, when, and under which constraints a
                technique is used.
              </p>
            </article>
            <article>
              ...
              <p>
                Sensory decisions need richer vocabularies, confidence, and evidence—not vague
        ...
        >
          <div className="site-shell section-heading-row">
            ...
            <p>
              The model below is a public working structure. Definitions and maturity states
              will evolve as research, product boundaries, and evidence become clearer.
            </p>
          </div>
          ...
          <div className="site-shell architecture-map">
            <div className="architecture-foundation">
              ...
              <p>
                Structures the shared language, records, workflows, and rules beneath the
                platform.
              </p>
            ...
            <div className="architecture-network">
              {architectureAreas.map((area) => (
                <article
                  key={area.name}
                  className={
                    area.name === "Culinary Intelligence"
                      ? "architecture-node architecture-node-primary"
                      : "architecture-node"
                  }
                >
            ...
            <p className="architecture-note">
              ...
              historical, and sensory context. They are not decorative sub-brands or equal
              product cards.
            </p>
          </div>
        </section>
        ...
        <section className="section capability-section" aria-labelledby="capability-title">
          <div className="site-shell split-layout">
            ...
            <div className="prose-stack">
              ...
              <p className="muted-copy">
                These are capability directions—not a claim that every function is publicly
                available today.
              </p>
            </div>
          </div>
          ...
          <div className="site-shell capability-list">
            {[
              "Structured culinary records",
              "Technique and transformation mapping",
              "Ingredient relationship analysis",
              "Historical and cultural provenance",
              "Sensory vocabulary and contrast",
              "Future expert decision support",
            ].map((item, index) => (
              <div key={item} className="capability-row">
                <span>{String(index + 1).padStart(2, "0")}</span>
                <h3>{item}</h3>
                <StatusPill>
                  {index < 2 ? "Foundational research" : "Future capability"}
                </StatusPill>
              </div>
            ))}
          </div>
        ...
        <section className="section evidence-section" aria-labelledby="evidence-title">
          <div className="site-shell evidence-layout">
            <div className="evidence-intro">
              ...
              <p>
                Authority should come from transparent methods, sources, limitations, versioned
                records, and real expert review—not from scale language or visual spectacle.
              </p>
            </div>
            <div className="evidence-grid">
              ...
              <article>
                ...
                <p>
                  Make product state visible so ambition never becomes unsupported marketing.
                </p>
              </article>
            </div>
          </div>
        ...
        >
          <div className="site-shell section-heading-row">
            ...
            <p>
              The public research layer will be developed as a durable, sourced record—not a
              continuous food-media feed.
            </p>
          </div>
        ...
        >
          <div className="site-shell split-layout">
            ...
            <p className="roadmap-intro">
              Public language should remain aligned with actual evidence. Dates and access
              commitments will only be added when dependencies are understood.
            </p>
          </div>
          ...
          <div className="site-shell partnership-inner">
            <div>
              ...
              <h2 id="partnership-title">
                For serious culinary, research, and institutional conversations.
              </h2>
            </div>
            <div>
              <p>
                CulinArchAI is currently defining its architecture, evidence standards, and
      ...
      <footer className="site-footer">
        <div className="site-shell footer-grid">
          ...
          <p className="footer-note">
            Working public foundation. Capability definitions, evidence, and access are still
            under development.
          </p>
        </div>
      </footer>
